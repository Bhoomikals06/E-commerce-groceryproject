...
// //           Shopping Cart{" "}
// //           <span className="text-sm text-indigo-500">{cartCount()}</span>
// //         </h1>
...
// //           <p className="flex justify-between">
// //             <span>Tax (2%)</span>
// //             <span>${totalCartAmount() * 0.02}/100</span>
// //           </p>
// //           <p className="flex justify-between text-lg font-medium mt-3">
// //             <span>Total Amount:</span>
// //             <span>
// //               ${totalCartAmount() + (totalCartAmount() * 0.02) / 100}{" "}
// //             </span>
// //           </p>
// //         </div>
...
//     for (const key in cartItems) {
//       const product = products.find((product) => product._id === key);
//       // Ensure product is found before adding to array
//       if (product) {
//         // Create a new object for each cart item to avoid direct state mutation
//         tempArray.push({
//           ...product,
...
//       getCart();
//     } else {
//       setCartArray([]); // Clear array if cart is empty
//     }
//   }, [products, cartItems]);

//   const totalAmount = totalCartAmount();
//   const taxAmount = totalAmount * 0.02;
//   const grandTotal = Math.floor((totalAmount + taxAmount) * 100) / 100;
...
//                     `product/${product.category.toLowerCase()}/${product._id}`
//                   );
//                   // FIX: scrollTo is a global window method
//                   window.scrollTo(0, 0);
//                 }}
//                 className="cursor-pointer w-24 h-24 flex items-center justify-center border border-gray-300 rounded overflow-hidden"
//               >
...
//           <p className="flex justify-between">
//             <span>Price</span>
//             {/* CORRECTION 2: Removed 'products' argument which is not needed */}
...
//           <p className="flex justify-between">
//             <span>Tax (2%)</span>
//             {/* CORRECTION 1: Fixed Tax Calculation */}
//             <span>${taxAmount.toFixed(2)}</span>
//           </p>
//           <p className="flex justify-between text-lg font-medium mt-3">
//             <span>Total Amount:</span>
//             {/* CORRECTION 1: Fixed Total Calculation */}
...
//     </div>
//   ) : (
//     // Render a message or redirect if the cart is empty
